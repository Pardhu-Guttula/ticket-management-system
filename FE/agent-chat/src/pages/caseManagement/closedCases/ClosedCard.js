...
function ClosedCard() {
  ...
  const cards = [
    { id: 1, userName: "User 1", description: "Short Description 1", priority: "High" },
    { id: 2, userName: "User 2", description: "Short Description 2", priority: "Medium" },
    { id: 3, userName: "User 3", description: "Short Description 3", priority: "Low" },
  ];
            ...
            <div className="flex justify-center items-center h-full">
              <div className="w-11/12">
                {cards.map((card) => (
                  <div
                    key={card.id}
                    className="container mx-auto px-4 py-5 bg-card relative max-w-full overflow-hidden rounded-md shadow-lg flex justify-between items-center mb-4"
