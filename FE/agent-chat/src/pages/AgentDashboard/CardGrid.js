  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-center items-center">
      {cardData.map((card, index) => (
        <>
          <div class="flex items-center p-4 bg-card relative  overflow-hidden rounded-md shadow-lg group bg-white rounded-md shadow-lg">
            ...
            <section class="block border-l border-gray-300 m-3">
              <div class="pl-3">
                ...
                <h3 class="bg-clip-text text-transparent bg-gradient-to-l from-[#005BC4] to-[#27272A] text-md font-bold">
                  {card.content}
                </h3>
              </div>
            </section>
